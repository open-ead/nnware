...
public:
    ...
    void SetFrustum(float, float, float, float, float, float, const nn::util::neon::MatrixRowMajor4x3fType&);
    void SetOrtho(float, float, float, float, float, float, const nn::util::neon::MatrixRowMajor4x3fType&);
